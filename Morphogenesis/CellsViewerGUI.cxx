...
inline void CellsViewerGUI::cb_Cells_i(Fl_Menu_*, void*) {
  ShowDisplay();
}
void CellsViewerGUI::cb_Cells(Fl_Menu_* o, void* v) {
  ((CellsViewerGUI*)(o->parent()->user_data()))->cb_Cells_i(o,v);
}

inline void CellsViewerGUI::cb_Species_i(Fl_Menu_*, void*) {
  ShowSpecies();
}
void CellsViewerGUI::cb_Species(Fl_Menu_* o, void* v) {
  ((CellsViewerGUI*)(o->parent()->user_data()))->cb_Species_i(o,v);
}
...
Fl_Menu_Item CellsViewerGUI::menu_[] = {
 ...
 {"Cells", 0,  (Fl_Callback*)CellsViewerGUI::cb_Cells, 0, 0, 0, 0, 14, 0},
 {"Species", 0,  (Fl_Callback*)CellsViewerGUI::cb_Species, 0, 0, 0, 0, 14, 0},
 {0},
 {0}
};
...
inline void CellsViewerGUI::cb_7_i(Fl_Button*, void*) {
  // ClearAggregate();
}
void CellsViewerGUI::cb_7(Fl_Button* o, void* v) {
  ((CellsViewerGUI*)(o->parent()->user_data()))->cb_7_i(o,v);
}
...
inline void CellsViewerGUI::cb_speciesBrowser_i(Fl_Browser*, void*) {
  createEggButton->activate();
}
void CellsViewerGUI::cb_speciesBrowser(Fl_Browser* o, void* v) {
  ((CellsViewerGUI*)(o->parent()->user_data()))->cb_speciesBrowser_i(o,v);
}

inline void CellsViewerGUI::cb_createEggButton_i(Fl_Button*, void*) {
  SelectSpecies( speciesBrowser->value()-1 );
speciesWindow->hide();
}
void CellsViewerGUI::cb_createEggButton(Fl_Button* o, void* v) {
  ((CellsViewerGUI*)(o->parent()->user_data()))->cb_createEggButton_i(o,v);
}

inline void CellsViewerGUI::cb_Close_i(Fl_Button*, void*) {
  speciesWindow->hide();
}
void CellsViewerGUI::cb_Close(Fl_Button* o, void* v) {
  ((CellsViewerGUI*)(o->parent()->user_data()))->cb_Close_i(o,v);
}
...
CellsViewerGUI::CellsViewerGUI() {
  ...
  { Fl_Window* o = controlWindow = new Fl_Window(252, 162, "Control Panel");
    ...
    { Fl_Button* o = new Fl_Button(140, 35, 60, 20, "@#7+");
      o->labeltype(FL_SYMBOL_LABEL);
  ...
  { Fl_Window* o = substratesWindow = new Fl_Window(249, 146, "Substrates");
    w = o;
    o->user_data((void*)(this));
    { Fl_Browser* o = substratesBrowser = new Fl_Browser(10, 10, 230, 125);
      o->type(1);
  ...
  { Fl_Window* o = speciesWindow = new Fl_Window(278, 193, "Species");
    w = o;
    o->user_data((void*)(this));
    { Fl_Browser* o = speciesBrowser = new Fl_Browser(10, 10, 260, 140);
      o->type(2);
      o->callback((Fl_Callback*)cb_speciesBrowser);
    }
    { Fl_Button* o = createEggButton = new Fl_Button(25, 160, 100, 25, "Create Egg");
      o->callback((Fl_Callback*)cb_createEggButton);
      o->deactivate();
    }
    { Fl_Button* o = new Fl_Button(150, 160, 100, 25, "Close");
