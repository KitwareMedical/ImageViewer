/*=========================================================================
  ...
  Module:    MRFGaussianClassifierValidationApp.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef _MRFGaussianClassifierValidationApp_h
#define _MRFGaussianClassifierValidationApp_h
...
/** \class MRFGaussianClassifierValidationApp
 * 
...
public ClassifierApplicationBase<
  ...
  MRFGaussianImageClassifierApp<TImage,TMaskImage>,
  ClassifierValidationOutput<TMaskImage> >
{
public:

  /** Standard class typedefs. */
  typedef MRFGaussianClassifierValidationApp Self;
  ...
  itkTypeMacro(MRFGaussianClassifierValidationApp, ClassifierApplicationBase);
...
protected:
  ...
  virtual ~MRFGaussianClassifierValidationApp(){};
...
#include "MRFGaussianClassifierValidationApp.txx"
#endif
