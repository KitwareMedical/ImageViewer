/*=========================================================================
  ...
  Module:    MRFGaussianClassifierValidationApp.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
int main(int argc, char *argv[])
{
  ...
  if ( argc < 2 )
    ...
    std::cout << std::endl;
    std::cout << "Usage:  MRFGaussianClassifierValidationApp param.file" << std::endl;
    return 1;
    }
  ...
  typedef itk::MRFGaussianClassifierValidationApp< VectorInputImageType,
  ...
  app->SetMaximumNumberOfIterations(50);
  app->SetErrorTolerance(0.10);
  app->SetNeighborhoodRadius( 1 );
  app->SetSmoothingFactor( 2 );
