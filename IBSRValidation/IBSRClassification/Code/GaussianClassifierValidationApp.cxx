/*=========================================================================
  ...
  Module:    GaussianClassifierValidationApp.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
int main(int argc, char *argv[])
{
  ...
  if ( argc < 2 )
    ...
    std::cout << std::endl;
    std::cout << "Usage:  GaussianClassifierValidationApp param.file" << std::endl;
    return 1;
    }
  ...
  typedef itk::GaussianClassifierValidationApp< VectorInputImageType,
