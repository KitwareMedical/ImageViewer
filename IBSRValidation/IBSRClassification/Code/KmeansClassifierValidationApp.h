/*=========================================================================
  ...
  Module:    KmeansClassifierValidationApp.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef _KmeansClassifierValidationApp_h
#define _KmeansClassifierValidationApp_h
...
/** \class KmeansClassifierValidationApp
 * 
...
public ClassifierApplicationBase<
  ...
  KmeansImageClassifierApp<TImage,TMaskImage>,
  ClassifierValidationOutput<TMaskImage> >
{
public:

  /** Standard class typedefs. */
  typedef KmeansClassifierValidationApp Self;
  ...
  itkTypeMacro(KmeansClassifierValidationApp, ClassifierApplicationBase);
...
protected:
  ...
  virtual ~KmeansClassifierValidationApp(){};
...
#include "KmeansClassifierValidationApp.txx"
#endif
