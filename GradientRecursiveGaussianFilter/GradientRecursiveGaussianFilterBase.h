...
public:
   ...
   */
   ...
   typedef itk::Image<  GradientVectorType, 
                        ImageDimension >                ImageGradientType; 
...
protected:
  ...
  GradientRecursiveGaussianFilterBase( 
          const GradientRecursiveGaussianFilterBase & ); // should not be defined 
  
  GradientRecursiveGaussianFilterBase operator=( 
          const GradientRecursiveGaussianFilterBase & ); // should not be defined 
