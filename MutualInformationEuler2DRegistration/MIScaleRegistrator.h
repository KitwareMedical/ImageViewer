...
=========================================================================*/
#ifndef _MIScaleRegistrator_h
#define _MIScaleRegistrator_h
...
class MIScaleRegistrator : public itk::Object
{
public:

  /** Standard class typedefs. */
  typedef MIScaleRegistrator Self;
  typedef itk::Object Superclass;
  typedef itk::SmartPointer<Self> Pointer;
  typedef itk::SmartPointer<const Self>  ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(MIScaleRegistrator, Object);
...
private:
  MIScaleRegistrator( const Self& ); //purposely not implemented
...
#include "MIScaleRegistrator.txx"
#endif
