/*=========================================================================
  ...
  Module:    MIAffine2DRegistrator.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef _MIAffine2DRegistrator_h
#define _MIAffine2DRegistrator_h
...
class MIAffine2DRegistrator : public itk::Object
{
public:

  /** Standard class typedefs. */
  typedef MIAffine2DRegistrator Self;
  typedef itk::Object Superclass;
  typedef itk::SmartPointer<Self> Pointer;
  typedef itk::SmartPointer<const Self>  ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(MIAffine2DRegistrator, Object);
...
private:
  MIAffine2DRegistrator( const Self& ); //purposely not implemented
...
#include "MIAffine2DRegistrator.txx"
#endif
