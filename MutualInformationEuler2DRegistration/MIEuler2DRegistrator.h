...
=========================================================================*/
#ifndef _MIEuler2DRegistrator_h
#define _MIEuler2DRegistrator_h
...
class MIEuler2DRegistrator : public itk::Object
{
public:

  /** Standard class typedefs. */
  typedef MIEuler2DRegistrator Self;
  typedef itk::Object Superclass;
  typedef itk::SmartPointer<Self> Pointer;
  typedef itk::SmartPointer<const Self>  ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(MIEuler2DRegistrator, Object);
...
private:
  MIEuler2DRegistrator( const Self& ); //purposely not implemented
...
#include "MIEuler2DRegistrator.txx"
#endif
