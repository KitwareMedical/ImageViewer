/*=========================================================================
  ...
  Module:    MIThinPlateSplineRegistrator.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef _MIThinPlateSplineRegistrator_h
#define _MIThinPlateSplineRegistrator_h
...
/** \class MIThinPlateSplineRegistrator
 *
...
class MIThinPlateSplineRegistrator : public itk::Object
{
public:

  /** Standard class typedefs. */
  typedef MIThinPlateSplineRegistrator Self;
  typedef itk::Object Superclass;
  typedef itk::SmartPointer<Self> Pointer;
  typedef itk::SmartPointer<const Self>  ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(MIThinPlateSplineRegistrator, Object);
...
private:
  MIThinPlateSplineRegistrator( const Self& ); //purposely not implemented
...
#include "MIThinPlateSplineRegistrator.txx"
#endif
