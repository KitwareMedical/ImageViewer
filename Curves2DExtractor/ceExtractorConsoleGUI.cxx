...
inline void ceExtractorConsoleGUI::cb_sigmaCounter_i(Fl_Counter* o, void*) {
  SetSigma( o->value() );
}
void ceExtractorConsoleGUI::cb_sigmaCounter(Fl_Counter* o, void* v) {
  ((ceExtractorConsoleGUI*)(o->parent()->parent()->user_data()))->cb_sigmaCounter_i(o,v);
}
...
inline void ceExtractorConsoleGUI::cb_extractedParametricPointsButton_i(fltk::LightButton*, void*) {
  ShowExtractedParametricPoints();
}
void ceExtractorConsoleGUI::cb_extractedParametricPointsButton(fltk::LightButton* o, void* v) {
  ((ceExtractorConsoleGUI*)(o->parent()->parent()->user_data()))->cb_extractedParametricPointsButton_i(o,v);
}

inline void ceExtractorConsoleGUI::cb_Spatial_i(Fl_Button*, void*) {
  ShowSpatialFunctionControl();
}
void ceExtractorConsoleGUI::cb_Spatial(Fl_Button* o, void* v) {
  ((ceExtractorConsoleGUI*)(o->parent()->parent()->user_data()))->cb_Spatial_i(o,v);
}

inline void ceExtractorConsoleGUI::cb_curve2DPointsButton_i(fltk::LightButton*, void*) {
  ShowCurve2DPoints();
}
void ceExtractorConsoleGUI::cb_curve2DPointsButton(fltk::LightButton* o, void* v) {
  ((ceExtractorConsoleGUI*)(o->parent()->parent()->user_data()))->cb_curve2DPointsButton_i(o,v);
}
...
ceExtractorConsoleGUI::ceExtractorConsoleGUI() {
  Fl_Window* w;
  { Fl_Window* o = consoleWindow = new Fl_Window(1012, 391, "2D Curves Extractor Console");
    w = o;
    o->user_data((void*)(this));
    { Fl_Group* o = Connectors = new Fl_Group(5, 5, 995, 255);
      ...
      { Fl_Box* o = new Fl_Box(915, 55, 10, 50);
        o->box(FL_UP_BOX);
        o->color(4);
      }
      ...
      { Fl_Box* o = new Fl_Box(835, 45, 65, 10);
        o->box(FL_UP_BOX);
        o->color(4);
      }
      ...
      { Fl_Box* o = new Fl_Box(915, 115, 10, 50);
        o->box(FL_UP_BOX);
        o->color(4);
      }
      o->end();
    }
    { Fl_Group* o = controlsGroup = new Fl_Group(5, 5, 995, 255);
      o->box(FL_DOWN_FRAME);
      o->deactivate();
      ...
      { Fl_Counter* o = sigmaCounter = new Fl_Counter(30, 190, 160, 25, "Sigma");
        o->minimum(-100);
        o->maximum(100);
        o->value(1);
        o->callback((Fl_Callback*)cb_sigmaCounter);
      ...
      { fltk::LightButton* o = parametricSpaceButton = new fltk::LightButton(745, 35, 105, 37, "Parametric Space");
        o->type(0);
        o->value(1);
        o->selection_color(1);
      ...
      { fltk::LightButton* o = extractedParametricPointsButton = new fltk::LightButton(870, 90, 100, 40, "Extracted Points");
        o->type(0);
        o->value(1);
        o->selection_color(1);
        o->callback((Fl_Callback*)cb_extractedParametricPointsButton);
        o->align(132|FL_ALIGN_INSIDE);
      }
      { Fl_Button* o = new Fl_Button(875, 30, 90, 45, "Spatial Function");
        o->box(FL_ROUND_UP_BOX);
        o->callback((Fl_Callback*)cb_Spatial);
        o->align(FL_ALIGN_WRAP);
      }
      { fltk::LightButton* o = curve2DPointsButton = new fltk::LightButton(870, 150, 100, 40, "Curve2D Points");
        o->type(0);
        o->value(1);
        o->selection_color(1);
        o->callback((Fl_Callback*)cb_curve2DPointsButton);
        o->align(132|FL_ALIGN_INSIDE);
      }
      o->end();
    }
    ...
    { Fl_Button* o = new Fl_Button(675, 275, 90, 30, "Quit");
      o->box(FL_ROUND_UP_BOX);
      o->callback((Fl_Callback*)cb_Quit);
    }
    { Fl_Button* o = new Fl_Button(305, 275, 215, 30, "Execute");
      o->box(FL_ROUND_UP_BOX);
      o->callback((Fl_Callback*)cb_Execute);
    }
    { Fl_Button* o = new Fl_Button(850, 300, 110, 75);
      o->box(FL_FLAT_BOX);
...
void ceExtractorConsoleGUI::ResetViewOfParametricSpace( void ) {
}

void ceExtractorConsoleGUI::ShowCurve2DPoints( void ) {
}

void ceExtractorConsoleGUI::ShowExtractedParametricPoints( void ) {
}
