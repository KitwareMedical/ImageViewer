...
ceExtractorConsoleGUI::ceExtractorConsoleGUI() {
  Fl_Window* w;
  { Fl_Window* o = consoleWindow = new Fl_Window(878, 391, "2D Curves Extractor Console");
    w = o;
    ...
    { fltk::ProgressBar* o = progressSlider = new fltk::ProgressBar(5, 324, 755, 15);
      o->type(3);
      o->selection_color(2);
    }
    statusTextOutput = new Fl_Output(5, 349, 755, 25);
    ...
    { Fl_Button* o = new Fl_Button(145, 280, 80, 30, "Quit");
      o->box(FL_ROUND_UP_BOX);
    ...
    { Fl_Button* o = new Fl_Button(765, 312, 110, 75);
      o->box(FL_FLAT_BOX);
