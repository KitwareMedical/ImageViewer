...
namespace itk
{
const FileIOMetaImage* FileIOMetaImageMaker::m_MyObject = FileIOMetaImage::New();
const FileIOMetaImageMaker* FileIOMetaImageMaker::m_RegisterThis = new FileIOMetaImageMaker;
