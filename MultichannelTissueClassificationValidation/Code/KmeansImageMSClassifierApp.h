/*=========================================================================
  ...
  Module:    KmeansImageMSClassifierApp.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef _KmeansImageMSClassifierApp_h
#define _KmeansImageMSClassifierApp_h
...
/** \class KmeansImageMSClassifierApp
 *
...
class ITK_EXPORT KmeansImageMSClassifierApp : public Object
{
public:

  /** Standard class typedefs. */
  typedef KmeansImageMSClassifierApp Self;
  typedef Object Superclass;
  typedef SmartPointer<Self> Pointer;
  typedef SmartPointer<const Self>  ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(KmeansImageMSClassifierApp, Object);
...
private:
  KmeansImageMSClassifierApp( const Self& ); //purposely not implemented
...
#include "KmeansImageMSClassifierApp.txx"
#endif
