/*=========================================================================
  ...
  Module:    MRFKmeansMSClassifierValidationApp.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef _MRFKmeansMSClassifierValidationApp_h
#define _MRFKmeansMSClassifierValidationApp_h
...
/** \class MRFKmeansMSClassifierValidationApp
 * 
...
public MSClassifierApplicationBase<
  ...
  MRFKmeansImageMSClassifierApp<TImage,TMaskImage>,
  MSClassifierValidationOutput<TMaskImage> >
{
public:

  /** Standard class typedefs. */
  typedef MRFKmeansMSClassifierValidationApp Self;
  ...
  itkTypeMacro(MRFKmeansMSClassifierValidationApp, MSClassifierApplicationBase);
...
protected:
  ...
  virtual ~MRFKmeansMSClassifierValidationApp(){};
...
#include "MRFKmeansMSClassifierValidationApp.txx"
#endif
