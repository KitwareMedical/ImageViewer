/*=========================================================================
  ...
  Module:    MRFGaussianMSClassifierValidationApp.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
int main(int argc, char *argv[])
{
  ...
  if ( argc < 2 )
    ...
    std::cout << std::endl;
    std::cout << "Usage:  MRFGaussianMSClassifierValidationApp param.file" << std::endl;
    return 1;
    }
  ...
  typedef itk::MRFGaussianMSClassifierValidationApp< VectorInputImageType,
  ...
  app->SetErrorTolerance(0.20);

  app->SetNeighborhoodRadius( 1 );

  app->SetSmoothingFactor( 1 );
