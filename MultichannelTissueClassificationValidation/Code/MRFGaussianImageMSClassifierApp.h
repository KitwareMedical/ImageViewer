/*=========================================================================
  ...
  Module:    MRFGaussianImageMSClassifierApp.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef _MRFGaussianImageMSClassifierApp_h
#define _MRFGaussianImageMSClassifierApp_h
...
/** \class MRFGaussianImageMSClassifierApp
 *
...
class ITK_EXPORT MRFGaussianImageMSClassifierApp : public Object
{
public:

  /** Standard class typedefs. */
  typedef MRFGaussianImageMSClassifierApp Self;
  typedef Object Superclass;
  typedef SmartPointer<Self> Pointer;
  typedef SmartPointer<const Self>  ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(MRFGaussianImageMSClassifierApp, Object);
...
private:
  MRFGaussianImageMSClassifierApp( const Self& ); //purposely not implemented
...
#include "MRFGaussianImageMSClassifierApp.txx"
#endif
