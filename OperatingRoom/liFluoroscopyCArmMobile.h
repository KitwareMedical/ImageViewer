...
public:
   ...
   * This is the used to compute the field of view.
   */
  double GetDetectorRadius( void ) const;


  /**
   * Get the vertical direction of the X-rays detector.
   * This is the central point of the image
   * intensifier.
   */
  ...
  /**
   * Refresh the observers after a change in 
   * position or in geometry
   */
