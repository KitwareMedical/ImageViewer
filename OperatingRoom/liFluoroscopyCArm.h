...
public:
  ...
  /** Get the direction of the vertical from the detector's point of view. */
  const VectorType & GetDetectorVerticalDirection( void ) const;

  /** Get the radius of the X-rays detector.  This is used to compute the
   *  field of view.  */
...
private:
  ...
  /** Axial offset of the image intensifier. * This value changes de
   * source-film distance and as a consequence alters the field of view */
