...
class MorphFunction : public LevelSet3DFunction< Image<float, 3> >
{
public:
  ...
  typedef LevelSet3DFunction< Image<float, 3> > Superclass;
   ...
   */
  itkTypeMacro( MorphFunction, LevelSet3DFunction );
