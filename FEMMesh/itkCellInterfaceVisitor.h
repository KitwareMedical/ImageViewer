...
public: 
  ...
  virtual void VisitFromCell(unsigned long cellId, CellInterface<TCellTraits>*) = 0;
...
>
class CellInterfaceVisitorImplementation : 
    public CellInterfaceVisitor<TCellTraits>, public UserVisitor
{
public:
  /** Standard class typedefs. */
  ...
  void VisitFromCell(unsigned long cellId, CellInterface<TCellTraits>* c)
    {
