...
# Sanity checks.
if( DEFINED FLTK_DIR AND NOT EXISTS ${FLTK_DIR} )
  message( FATAL_ERROR "FLTK_DIR variable is defined but corresponds to a nonexistent directory" )
endif( DEFINED FLTK_DIR AND NOT EXISTS ${FLTK_DIR} )
...
if( NOT DEFINED FLTK_DIR AND NOT ${USE_SYSTEM_FLTK} )
  ...
  ExternalProject_Add( FLTK
    ...
    CMAKE_ARGS
      ...
      -DCMAKE_INSTALL_PREFIX:PATH=${FLTK_BINARY_DIR}
      ${CMAKE_OSX_EXTERNAL_PROJECT_ARGS}
      -DOPTION_BUILD_EXAMPLES:BOOL=OFF )

  if( WIN32 )
    set( FLTK_DIR ${FLTK_BINARY_DIR}/CMake )
  elseif( APPLE )
    set(FLTK_DIR ${FLTK_BINARY_DIR}/FLTK/.framework/Resources/CMake)
  else( WIN32 )
    set(FLTK_DIR ${FLTK_BINARY_DIR}/lib/FLTK-1.3)
  endif( WIN32 )
