#!/bin/csh
#
# Register MRI Data uing Mutual Information
#

set MRIDATA=/home/lorensen/InsightData/MultiFieldMRI
set MRIRegistration=/home/lorensen/Insight-solaris/Examples/MRIRegistration/MRIRegistration
...
${MRIRegistration}     --study2Prefix ${MRIDATA}/HighField/e2     --study2Resolution 256 256 55     --study2Spacing .78125 .78125 1.5     --study1Prefix ${MRIDATA}/LowField/e2     --study1Resolution 256 256 55     --study1Spacing .78125 .78125 1.5     --translateScale 64     --shrink 2 2 1     --learningRate .005     --standardDeviation 2     --numberOfSamples 50     --numberOfIterations 1000 <guess2 >guess3
${MRIRegistration}     --study2Prefix ${MRIDATA}/HighField/e2     --study2Resolution 256 256 55     --study2Spacing .78125 .78125 1.5     --study1Prefix ${MRIDATA}/LowField/e2     --study1Resolution 256 256 55     --study1Spacing .78125 .78125 1.5     --translateScale 64     --shrink 1 1 1     --learningRate .005     --standardDeviation 2     --numberOfSamples 50     --numberOfIterations 1000 <guess3 >guess4
