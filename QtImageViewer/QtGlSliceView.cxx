...
#include "itkMinimumMaximumImageCalculator.h"
 ...
 //:SliceView(0, 0, this->width(), this->height(), "none")
...
/*
void QtGlSliceView::resize(int x, int y, int w, int h)
{
  SliceView::resize(x, y, w, h);
...
void QtGlSliceView::paintGL(void)
  ...
  //std::cout << "SliceView2 : cW " << this->width() << " cH = " << cH << std::endl; 
