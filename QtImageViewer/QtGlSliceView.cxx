    ...
    case Qt::Key_U:
        if (cClickMode == CM_RULER) {
            if (keyEvent->modifiers() & Qt::CTRL) {
                ...
                setIsONSDMetaData(!isONSDMetaData);
            }
        }
        break;
    case Qt::Key_E:
...
void QtGlSliceView::setIsONSDMetaData(bool flag) {
    isONSDMetaData = !isONSDMetaData;
    cCurrentRulerMetaFactory = isONSDMetaData ? cONSDMetaFactory : cRainbowMetaFactory;
