...
extern "C" int Vtkvtkitkcommontcl_Init(Tcl_Interp *interp);
extern "C" int Vtkwstcommontcl_Init(Tcl_Interp *interp);
...
int Tcl_AppInit(Tcl_Interp *interp)
{
  ...
  if (Vtkvtkitkcommontcl_Init(interp) == TCL_ERROR) 
    {
    return TCL_ERROR;
    }
  if (Vtkwstcommontcl_Init(interp) == TCL_ERROR) 
    {
    return TCL_ERROR;
    }
