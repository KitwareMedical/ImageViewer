...
fltkSlice3DDrawerGUI::fltkSlice3DDrawerGUI() {
  Fl_Window* w;
  { Fl_Window* o = VolumeWindow = new Fl_Window(463, 100, "Data Volume");
    w = o;
    o->user_data((void*)(this));
    { Fl_Scrollbar* o = xScrollBar = new Fl_Scrollbar(33, 15, 345, 20, "X : ");
      o->type(1);
      o->box(FL_DOWN_BOX);
      o->callback((Fl_Callback*)cb_xScrollBar);
      o->align(FL_ALIGN_LEFT);
    }
    { Fl_Scrollbar* o = yScrollBar = new Fl_Scrollbar(33, 35, 345, 20, "Y : ");
      o->type(1);
      o->box(FL_DOWN_BOX);
      o->callback((Fl_Callback*)cb_yScrollBar);
      o->align(FL_ALIGN_LEFT);
    }
    { Fl_Scrollbar* o = zScrollBar = new Fl_Scrollbar(33, 55, 345, 20, "Z : ");
      o->type(1);
      o->box(FL_DOWN_BOX);
      o->callback((Fl_Callback*)cb_zScrollBar);
      o->align(FL_ALIGN_LEFT);
    }
    xValueOutput = new Fl_Value_Output(383, 15, 40, 20);
    { Fl_Check_Button* o = xCheckButton = new Fl_Check_Button(423, 10, 30, 30);
      o->down_box(FL_DIAMOND_DOWN_BOX);
      o->selection_color(2);
      o->callback((Fl_Callback*)cb_xCheckButton);
      o->align(FL_ALIGN_CENTER);
    }
    { Fl_Check_Button* o = yCheckButton = new Fl_Check_Button(423, 30, 30, 30);
      o->down_box(FL_DIAMOND_DOWN_BOX);
      o->selection_color(2);
      o->callback((Fl_Callback*)cb_yCheckButton);
      o->align(FL_ALIGN_CENTER);
    }
    { Fl_Check_Button* o = zCheckButton = new Fl_Check_Button(423, 50, 30, 30);
      o->down_box(FL_DIAMOND_DOWN_BOX);
      o->selection_color(2);
      o->callback((Fl_Callback*)cb_zCheckButton);
      o->align(FL_ALIGN_CENTER);
    }
    yValueOutput = new Fl_Value_Output(383, 35, 40, 20);
    zValueOutput = new Fl_Value_Output(383, 55, 40, 20);
    o->end();
  }
}
